...
const HW6 = () => {
    ...
    const restore = () => {
        console.log(localStorage['hw6-editable-span-value'])
        restoreState('hw6-editable-span-value', localStorage['hw6-editable-span-value'])
        setValue(JSON.parse( localStorage['hw6-editable-span-value'] ))
        // делают студенты
    }
